...
const DiscoverUs = () => {
  ...
  return (
    <div className="discover-us-container bg-slate-700">
      ...
      <div className="discover-us-content bg-slate-70  my-2 rounded-2xl text-center">
        ...
        <h1 className="text-4xl font-bold mb-4 bg-slate-800 text-gray-300  p-4 rounded-2xl">
          <h1 className='text-lg'>{content.ourCollections}</h1>
        </h1>

        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className=" bg-slate-800 p-4 rounded-2xl">
            <p className="text-b-500 font-bold mb-2">{content.premiumDairy}</p>
          ...
          <div className=" bg-slate-800 p-4 rounded-2xl">
            ...
            <p className="text-gray-300">
              Indulge in exquisite <span className="text-red-500">GulabJamun</span>, Chamcham, Dairy Fresh Surbhi Rabri  and more.
            </p>
          </div>
        ...
        <div className=" p-4 my-4 bg-slate-800  rounded-2xl">
        ...
        {/* Contact Details */}
        <div className="contact-section mt-8  bg-slate-800 p-8 rounded-2xl">
