...
const Contact = () => {
  ...
  return (
    <div className="contact-container sm:m-10  text-white">
      ...
      <div className="contact-content rounded-2xl text-center">
        <h1 className="text-4xl font-bold mb-6 bg-slate-800 text-blue-500 p-4 rounded-2xl">
          Contact Us
        </h1>

        <div className="text-box mt-8 p-6 bg-gray-800 rounded-2xl">
        ...
        <div className="contact-details mt-8 bg-opacity-25 bg-gray-800 p-6 rounded-2xl">
        ...
        <div className="google-maps mt-8 rounded-2xl bg-slate-800 p-4">
          <iframe
